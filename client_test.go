...
func TestClient_DeleteAuth(t *testing.T) {
	...
	err := c.DeleteAuth("f3a67e46872907cf5cc11694d40fd483395132aef2b059c87ba729174e2026b6")
	fmt.Println(err)
}
func TestClient_PushSingleByCid(t *testing.T) {
	err := client.PushSingleByCid("3865f9358473b088a0b00aab2ce82f1bb99c1e2c0d11d31fc25c1db9d705a83d",
		"ec9d386372f37b299cd801bfa3df8ae81", "ec9d386372f37b299cd801bfa3df8ae8", &Notification{
			Title:     "这是标题",
...
func TestClient_PushBatchByCid(t *testing.T) {
	err := client.PushSingleBatchByCid("3865f9358473b088a0b00aab2ce82f1bb99c1e2c0d11d31fc25c1db9d705a83d", []string{"ec9d386372f37b299cd801bfa3df8ae8"}, []string{"ec9d386372f37b299cd801bfa3df8ae8"}, &Notification{
		Title:     "这是标题",
		Body:      "这是我要提示你的内容，快来看看吧。",
		ClickType: "startapp",
